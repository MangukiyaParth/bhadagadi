...
function add_vehicle_requirement()
{
	...
	if ($result) {
		...
		$message = $from_text . " to " . $to_text . " on (" . $car_type_text . ")" . $pickup_date . " " . $pickup_time;
		$gh->SendAndroidPushNotification($device_token_array, "New Requirement", " to ", $extra_args = array());
		/*********************/
