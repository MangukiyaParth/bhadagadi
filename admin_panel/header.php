...
$logo = "images/logo".(IS_PRODUCTION ? "" : (IS_SANDBOX ? "_sandbox" : "_beta")) . ".png";
...
if($current_module_name==""){
	if($current_file_name=="index.php"){
		...
		$html_title="Bhadagadi: ". $current_module_name.": ". str_replace("\'","'",$logged_in_username). " [" . $logged_in_email. "]";
	}elseif($current_file_name=="login.php"){
		$html_title="Bhadagadi";
	}
	else{
		$html_title="Bhadagadi: ". str_replace("\'","'",$logged_in_username). " [" . $logged_in_email. "]";
	}
}
else{
	if($current_file_name=="index.php"){
...
<head>
	...
	<meta name="keywords" content="Bhadagadi" />
	<meta name="description" content="Bhadagadi User Panel">
...
<body class="<?php if($current_page=='index') { echo 'authentication-bg'; } ?>">
	<div class="wrapper">
