...
<div class="leftside-menu">
    ...
    <a href="index.php" class="logo logo-dark">
        <span class="logo-lg">
            <img src="assets/images/logo-dark.png" alt="dark logo" height="60">
        </span>
        <span class="logo-sm">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="manage_banner.php" class="side-nav-link">
                    <i class="uil-image"></i>
                    <span> Banners </span>
                </a>
            </li>
            ...
            <li class="side-nav-item">
                <a href="manage_requirements.php" class="side-nav-link">
                    <i class="uil-user"></i>
